...
**Executable tip now:** **§4.56** flatten / trowel (terrain-tools wave after §4.55 bucket/shovel); parallel **§4.46** HSI curve-shape corrections. **§4.45** fuel/scar shipped; **§4.55** brush size shipped. Living-wave remainder blocked: **L5** on **C-023**; **L8** on **C-024** + **C-025**.
