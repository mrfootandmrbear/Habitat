...
**Executable tip now (updated 2026-08-06):** Sole open executable machine slice is **Track A §4.67** Seed disperser (extends A1's `populations` Process — **§4.66** Herbivore machine half shipped 2026-08-05; D-007 clip verdict outstanding, [ask](docs/playtests/A1-herbivore.md), gates any *other* new-Process slice, not this one). Track V **§4.60–§4.62** Done ([plant-render-composite-guild-composition.md](docs/slices/plant-render-composite-guild-composition.md)); **§4.63** deferred (post-composite dual-fill smoke **32.23ms**). Track R, Track T, and the Living wave (through L5, **C-023 Locked**) stay Done; remaining owner-judged taste (**C-014**, **C-021**, **C-022**, **C-026**, **C-028**) and **L8** (**C-024**/**C-025**) stay off tip. Mesopredator/apex-predator roles, ecosystem-engineer write-back, and adaptive radiation (**C-029**, Open) stay off Track A specifically — see [C-027-framing.md](docs/candidates/C-027-framing.md) §4.6/§5 and [C-029-framing.md](docs/candidates/C-029-framing.md).
...
- **Succession.** Merge-gated multi-agent pipeline: [docs/CLOUD_AGENT_PIPELINE.md](docs/CLOUD_AGENT_PIPELINE.md). One BUILD_GUIDE slice per cloud run. Track R, Track T, Track V (§4.60–§4.62), and the Living wave are Done. Sole open machine slice: **Track A §4.67** Seed disperser fields (extends A1's `populations` Process — **§4.66** Herbivore shipped its machine half 2026-08-05, D-007 clip verdict outstanding, [ask](docs/playtests/A1-herbivore.md), gates any *other* new-Process slice but not this one). Foxel silhouette/variant design for Track A is a separate low-cost lane, not a cloud-succession track: [docs/animal-design/PROTOCOL.md](docs/animal-design/PROTOCOL.md). If that tip is taken and no owner decision has landed on the remaining backlog (C-024/C-025/C-026/C-028 taste, or the C-029 Lock for adaptive radiation), write a blocked note naming that backlog and stop; do not start mesopredator/apex-predator/ecosystem-engineer/adaptive-radiation work off your own initiative — those stay gated per [C-027-framing.md](docs/candidates/C-027-framing.md) §4.6/§5. Rebase onto `main`; leave tip accurate for the next merge-triggered agent.
