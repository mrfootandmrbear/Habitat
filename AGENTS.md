...
Slices **14** / **16** / **15** Tier-O **Pass**; **Slice F** Done (§4.11b). Next: **Slice 17** tidal envelope (§4.12). Maritime candidates C-015…C-019 Open; **C-020** lite via F (full clouds later). W-001 supersession still owner.
