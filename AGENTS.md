...
**Executable tip now (updated 2026-08-05):** **F-001 undeferred; C-027 Locked.** Track A (animal life) opened — tip **§4.66** Herbivore population/trait fields ([BUILD_GUIDE](docs/BUILD_GUIDE.md), [CLOUD_AGENT_PIPELINE.md](docs/CLOUD_AGENT_PIPELINE.md) §3), first `populations` Process, D-007 clip gate applies. Track V's **§4.62** composite runner-up guild remains open in parallel. Everything else in this paragraph's earlier form still holds: Track R, Track T, and the Living wave (through L5) stay Done; remaining owner-judged taste (**C-014**, **C-021**, **C-022**, **C-026**, **C-028**) and **L8** (**C-024**/**C-025**) stay off tip. Mesopredator/apex-predator roles, ecosystem-engineer write-back, and adaptive radiation (**C-029**, Open) stay off Track A specifically — see [C-027-framing.md](docs/candidates/C-027-framing.md) §4.6/§5 and [C-029-framing.md](docs/candidates/C-029-framing.md).
