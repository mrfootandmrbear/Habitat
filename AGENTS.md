...
Slices **14** / **16** / **15** Tier-O **Pass**; **Slice F** Done; **Slice 17** Done (§4.12). Next: **Slice 18** wave exposure (§4.13). Maritime candidates C-015…C-019 Open; **C-020** lite via F (full clouds later). W-001 supersession still owner.
