...
**Executable tip now:** **§4.47** Guild cover & light-competition correctness (parallel review queue). **§4.46** HSI curves shipped. **§4.45** fuel/scar shipped. Living-wave remainder blocked: **L5** on **C-023**; **L8** on **C-024** + **C-025**.
