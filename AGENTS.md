...
**Executable tip now:** **§4.46** HSI curve-shape corrections (parallel review queue). **§4.45** fuel/scar shipped. Living-wave remainder blocked: **L5** on **C-023**; **L8** on **C-024** + **C-025**.
