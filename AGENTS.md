...
**Executable tip now:** **§4.57** geometric mold stamps (terrain-tools wave); parallel **§4.47** guild cover & light-competition correctness. **§4.46** HSI curves shipped. **§4.45** fuel/scar shipped; **§4.55** / **§4.56** / **§4.54** shipped. Living-wave remainder blocked: **L5** on **C-023**; **L8** on **C-024** + **C-025**.
