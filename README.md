...
**Post-MVP:** autonomous closeouts ([BUILD_GUIDE.md](docs/BUILD_GUIDE.md) §4.1) — **probe baseline harness done**; next **`deep-time` probe**, then **Slice 8b** groundwater / baseflow (**C-001**).
