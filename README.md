...
**Next.** **Track A §4.67** Seed disperser fields — **§4.66** Herbivore machine half shipped (**F-001 undeferred**, **C-027 Locked**; D-007 clip outstanding, [ask](docs/playtests/A1-herbivore.md)). **L8** Done — deep-time skip + presentation LOD; **C-024** / **C-025 Locked**. Performance follow-on: SIM §6.5 #2. Track V **§4.60–§4.62** Done; **§4.63** deferred. Track R / Track T / Living wave Done. Owner Lock backlog (**C-014** hearable, **C-021**/**C-022**/**C-028** taste, **C-010** later, **C-029** adaptive radiation) runs in parallel.
