...
**Next.** Living wave tip is blocked (**L5** on **C-023**, **L8** on **C-024**/**C-025**). Executable tip: **§4.45** fuel/scar numeric fix ([BUILD_GUIDE §4.45](docs/BUILD_GUIDE.md)). Owner Lock backlog (**C-014** hearable, **C-021**/**C-022** taste, **C-010** later) runs in parallel.
