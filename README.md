...
**Next.** Executable tip: **§4.48** habitat/dispersal determinism hygiene ([BUILD_GUIDE §4.48](docs/BUILD_GUIDE.md), Track R — **§4.47** guild cover & light-competition correctness Done). Living wave blocked (**L5** / **L8**). Track T (terrain tools) parked — no further machine slice, only owner taste. Owner Lock backlog (**C-014** hearable, **C-021**/**C-022**/**C-028** taste, **C-010** later) runs in parallel.
