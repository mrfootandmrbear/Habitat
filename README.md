...
**Next.** Executable tip: **§4.57** geometric mold stamps ([BUILD_GUIDE §4.57](docs/BUILD_GUIDE.md)); parallel **§4.48** habitat/dispersal determinism hygiene (**§4.47** guild cover & light-competition correctness Done). Living wave blocked (**L5** / **L8**). Owner Lock backlog (**C-014** hearable, **C-021**/**C-022** taste, **C-010** later) runs in parallel.
