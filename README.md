...
**Post-MVP:** Dry-down ET coupling **Done** (agent) — insolation × cover partitions after Slice 11 light. Next: **Slice 12** arrival / first occupant (specified under C-007 — BUILD_GUIDE §4.8). Slice **A** audio wired into the play loop (C-014 Open). Slice 8c Tier-O still batched.
