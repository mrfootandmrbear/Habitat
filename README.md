...
**Next.** Two parallel executable tracks. Track R tip: **§4.48** habitat/dispersal determinism hygiene ([BUILD_GUIDE §4.48](docs/BUILD_GUIDE.md) — **§4.47** guild cover & light-competition correctness Done). Track V tip (new, 2026-08-03): **§4.60** plant rendering — per-guild silhouette geometry ([plant rendering review](docs/reviews/2026-08-03-plant-rendering-review.md); owner agreed to ship plant rendering now over animals, which stay gated on **F-001**); **§4.61**/**§4.62** queued behind it, **§4.63** deferred pending profiling. Living wave blocked (**L5** / **L8**). Track T (terrain tools) parked — no further machine slice, only owner taste. Owner Lock backlog (**C-014** hearable, **C-021**/**C-022**/**C-028** taste, **C-010** later) runs in parallel.
