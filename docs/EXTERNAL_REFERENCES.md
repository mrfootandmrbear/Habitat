...
| **NATURAL_PROCESS_MATH orographic precip** | Study selection, 2026-07-30 (Slice F) | `P = P₀(1 + γ·u·∇z)` with land-mean normalize — climate mean stays on dial; geography places rain (**C-020** lite / **C-004**) | Full cloud / snow / sleet phase; cloud painter UX | `src/sim/climate/orographicPrecip.ts`, probe `orographic-wind`, [FORCE_PANEL.md](FORCE_PANEL.md) |
