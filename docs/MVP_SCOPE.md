...
| **21** | Island biogeography (**C-019**) | Overseas arrival; small vs large island | **Done** — agent; C-019 Open (owner sparse-earned batched) |

**MVP exit.** The player can: watch water and soil; commit a prediction and be wrong or right; site one cause and see the sim respond; see vegetation blunt runoff. Sandbox only. No win condition (G-001). **Sim MVP playtest Pass** at Slice 6. **Post-MVP ladder** (autonomous-first): … → Slice 14 / 16 / 15 Tier-O **Pass**; **Slice F** / **17** / **18** / **19** / **20** / **21** Done; next later stubs (AUD-003 / Field Notebook / scenario campaign); Slice A audio wired (C-014 Open); full **C-020** clouds/phase later.
