...
| **L2** | Standing biomass is a propagule source: seed = overseas + local convolution | A founded meadow spreads, stalls at salt, regrows from a refugium | **Done** — BUILD_GUIDE §4.37 (agent; only `deep-time` moved) |
| **W0** | Locked presentation debt: live audio, fire→biomass, pause+dig, seed | Still world on load; burn clears visible life; sound from fields; new island by seed | **Done** — BUILD_GUIDE §4.53 (agent; C-014 still Open, now hearable) |
| **L3** | Mortality as a rate, not a clamp | Short drought ridden out; long drought takes the stand; crust dies first, woody last | **Done** — BUILD_GUIDE §4.38 (agent; `dieback-lag`) |
| **L7** | Activity-gated event band | Dry spans skip surface+fire; hash-identical to ungated | **Done** — BUILD_GUIDE §4.42 (agent; `event-band-gate`) |
| **L4** | Biotic motion (wind sway) | Shoots lean with wind; calm is still | **Done** — BUILD_GUIDE §4.39 (presentation; D-007 clip Pass) |
| — | Starting surface (island form + mosaic) | Soft multi-hill canvas; shore→sand / inland→clay; flatter bedrock | **Done** — BUILD_GUIDE §4.54 (agent; terrain-tools prep) |
| — | Sculpt brush size (bucket / shovel) | Fine vs mass berm/dig/deposit footprint | **Done** — BUILD_GUIDE §4.55 (agent; C-028 framing) |
| — | Flatten / trowel edit | Level toward mean elev in brush; depth with elev | **Done** — BUILD_GUIDE §4.56 (agent; C-028 framing) |
| — | Geometric mold stamps | Cylinder / pyramid / terrace form stamps; depth with elev | **Done** — BUILD_GUIDE §4.57 (agent; C-028 framing) |
| — | Simple / Full control density | Simple keeps sculpt · primary forces · time; Full on demand | **Done** — BUILD_GUIDE §4.58 (agent; U-001) |
| — | Duplicator stamp | Copy a sculpted form's relief (+material); re-stamp elsewhere | **Done** — BUILD_GUIDE §4.59 (agent; C-028 structural kit complete) |
| — | Habitat/dispersal determinism hygiene | Establishment reads the HSI dispersal already computed, not a stale duplicate; order-independent guild update | **Done** — BUILD_GUIDE §4.48 (agent; 29 baselines refreshed) |
| **L5** | Guild competition / successional displacement | Shrub's canopy shades herb; herb rises, peaks, then genuinely recedes as shrub takes the cell — not parallel accumulation | **Done** — BUILD_GUIDE §4.40 (agent; **C-023 Locked**, owner delegated 2026-08-03; `succession-displace`) |
| — | Occupant sway direction correctness | Every shoot leans the same way under one wind; steady lean + gentle flutter, not a pendulum | **Done** — BUILD_GUIDE §4.60 (agent; corrects L4) |
| — | Plant rendering: composite runner-up guild | Mixed stands show second-highest guild at reduced scale, not just arg-max | **Done** — BUILD_GUIDE §4.62 (agent; Track V) |

**MVP exit.** The player can: watch water and soil; commit a prediction and be wrong or right; site one cause and see the sim respond; see vegetation blunt runoff. Sandbox only. No win condition (G-001). **Sim MVP playtest Pass** at Slice 6. **Post-MVP ladder** (autonomous-first): … → Slice 14 / 16 / 15 Tier-O **Pass**; **Slice F** / **17**–**21** Done; C-018 / C-019 Tier-O **Pass**; **Slice S** / **Slice R** Done — D-007 rain-feel clip **Pass**; **Slice A+** Done; **Field Notebook** **U-006 Locked**; **Full C-020 clouds** Done — **C-020 Locked** v2.0.13; **NS-006** / **NS-002** / **NS-004** / **NS-003** / **NS-005** / **NS-008** / **NS-007** / **NS-009** / **NS-010** / **NS-011** Done; **Slice B** (**C-005 Locked tooling**); **Slice E** Exner-lite Done; **C-006** / **C-013** / **C-002 Locked**; **Slice G** Done (machine half — **C-021** / **C-022** still Open); **L1** / **L6** Done; **L2** Done; **L3** Done; **L7** Done; **L4** Done; **W0** Done (§4.53); **§4.54** starting surface Done; **§4.55** brush size Done; **§4.56** flatten/trowel Done; **§4.57** mold stamps Done; **§4.58** Simple/Full chrome Done; **§4.59** duplicator stamp Done (C-028 structural kit now fully shipped); **§4.60** occupant sway direction correctness Done (corrects L4's downwind lean — was silently rotated by each cell's own random yaw; per-instance variety now rides the lean's magnitude, never its axis) and **§4.60** per-guild silhouettes Done; BUILD_GUIDE §4.44–§4.52 correctness fixes Done (Track R fully closed); **L5** guild competition Done, **C-023 Locked** (owner delegated, 2026-08-03) — Living wave fully closed except **L8** (blocked on **C-024**+**C-025**, both owner-judged Open). Gap review: [reviews/2026-07-30-sim-gap-review.md](reviews/2026-07-30-sim-gap-review.md). **Next:** Sole open executable machine slice: **Track A §4.67** Seed disperser fields — **§4.66** Herbivore shipped its machine half 2026-08-05 (**F-001 undeferred**, **C-027 Locked**, [C-027-framing.md](candidates/C-027-framing.md), first `populations` Process; D-007 clip verdict outstanding, [ask](playtests/A1-herbivore.md), gates any *other* new-Process slice, not §4.67 itself). Track V **§4.60–§4.62** Done (composite runner-up shipped); **§4.63** deferred. Foxel silhouette/variant design for Track A runs as a separate low-cost lane ([docs/animal-design/PROTOCOL.md](animal-design/PROTOCOL.md)), not a cloud-succession track. Track R, Track T, and the Living wave are all Done. Mesopredator/apex-predator roles, ecosystem-engineer write-back, and adaptive radiation (**C-029**, filed Open) stay off Track A. What's left otherwise is owner-judged: residual Lock **C-014** (now hearable); **C-021** / **C-022** / **C-026** / **C-028** / **C-029** taste sitting; **C-024** / **C-025** block L8; **C-010** implement later.
