...
This document does not specify the equations of individual processes. It specifies what a process is allowed to be. Per-process mathematics belongs in `HYDROLOGY_SPEC.md` and its siblings.
