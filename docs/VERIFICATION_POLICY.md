...
- Next scenarios: (none queued after dry-down). Live: `paired-storm`, `berm-reroute`, `basin-fill`, `deep-time`, `baseflow-persist`, `regime-divergence`, `limiting-shift`, `burn-recover`, `succession-diverge`, `drydown-feedback`, `disturbance-recovery`. Next planned: `arrival-earned` (Slice 12).
