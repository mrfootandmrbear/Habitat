...
- Next scenarios: `baseflow-persist` (Slice 8b — wet channel after dry days with vs. without GW), `limiting-shift` (Slice 9), `burn-recover` (Slice 10). Live: `paired-storm`, `berm-reroute`, `basin-fill`, `deep-time`.
