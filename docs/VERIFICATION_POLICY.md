...
- Next scenarios: `limiting-shift` (Slice 9), `burn-recover` (Slice 10), `regime-divergence` (Slice 8c). Live: `paired-storm`, `berm-reroute`, `basin-fill`, `deep-time`, `baseflow-persist`.
