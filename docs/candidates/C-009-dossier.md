...
**Owner 2026-07-30: Pass.** “It definitely reads as two different surfaces.” No inspector. **Locked** same day (owner Lock batch A).

Deposit + rock are machine-green under the same candidate. Not a full D-007 clip substitute — rain-feel (Slice R / C-020) remains a separate sentence if the twenty-second clip still fails on weather.
