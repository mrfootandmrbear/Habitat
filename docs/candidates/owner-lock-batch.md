...
| **C-005** | Did you want to fork the world and run it again under different forces — or did Compare feel like a debug panel? | ☑ **Locked as tooling** 2026-07-31 — debug panel, not core instrument |
| **C-013** | After you ran time and the undo button went away, did that feel fair — or like the game punished you for looking? | ☑ **Locked** 2026-07-31 — fair |
| **C-002** | Does the written near-channel erosion rule match the geomorphology you want Locked as policy? | ☑ **Locked** 2026-07-31 — ratify Slice 8 reading |
...
| **U-006** | After something on the map changed, did opening the notebook feel like answering a question you already had — or like the game explaining itself first? | ☑ **Locked** 2026-07-31 — yes, answers existing question |

Sitting file: [batch-stewardship-alive](../playtests/batch-stewardship-alive.md). Register **v2.0.12** for C-005 / C-013 / C-002 / U-006.

---

## Agent actions after your reply

1. **Lock** rows → flip Open→Locked (U-006 Current→Locked), strike §16 queue where listed, version-history line, `npm run conformance`, evidence in commit body. ✅ **A done** (v2.0.9). ✅ **B + C-004** (v2.0.10). ✅ **C-005 tooling / C-013 / C-002 / U-006** (v2.0.12).
2. **Supersede W-001** → W-001 Superseded; C-015 Locked; SIMULATION_MODEL / BUILD_GUIDE tip refresh. ✅ done.
3. **Hold** → dossier note + next encoding retune. **C-020** Hold Lock — glitches **named** G1–G5 (2026-07-31); fix then re-ask. **C-014** still Open (audio env).
