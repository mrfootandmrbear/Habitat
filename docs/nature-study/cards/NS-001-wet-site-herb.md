# NS-001 — Wet-site herbaceous pioneer

| Field | Value |
|---|---|
| id | NS-001 |
| lane | guild |
| title | Wet-site herbaceous pioneer |
| real_world_referent | Herbaceous pioneers take first in persistently damp hollows with enough soil depth |
| player_bet | If I keep a hollow wet and deep enough, soft green cover should appear there first — not on the dry ridge |
| maps_to_fields | veg.seedBank.herb, veg.establishment.herb, veg.biomass.herb, habitat.suitability |
