...
| maps_to_fields | shore.intertidal, seaLevel, habitat.suitability, habitat.limitingFactor, f_inundation (hydroperiod derived) |
| hsi_or_growth_rule | HSI = min(…, f_inundation); upland: 0 when hydroperiod > 0; marsh hump deferred (≠ f_salinity, ≠ f_spray) |
