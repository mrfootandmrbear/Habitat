...
const BASELINE_TOLERANCES: Record<string, Record<string, MetricTolerance>> = {
  ...
  // Slice L3 — bands-to-half are small integers; biomass floats carry abs
  // tolerance. Structural flags (hasLag / guildOrdered / …) must stay exact.
  "dieback-lag": {
    "lag.afterOneBand": { abs: 1e-5 },
    "lag.capacityLow": { abs: 1e-9 },
    "lag.excess": { abs: 1e-5 },
    "lag.worldAfterOne": { abs: 1e-5 },
    "lag.worldCapacity": { abs: 1e-5 },
    "lag.hsiBefore": { abs: 1e-5 },
    "lag.hsiAfter": { abs: 1e-5 },
    "order.crustBands": { abs: 0 },
    "order.herbBands": { abs: 0 },
    "order.shrubBands": { abs: 0 },
    "pulse.shortLived": { abs: 1e-5 },
    "pulse.longLived": { abs: 1e-5 },
    "asym.lossBands": { abs: 0 },
    "asym.recoveryBands": { abs: 0 },
    "delta.hasLag": { abs: 0 },
    "delta.guildOrdered": { abs: 0 },
    "delta.ridesShort": { abs: 0 },
    "delta.losesLong": { abs: 0 },
  ...
  "marsh-arrival": {
    "foreshore.marshBiomass": { abs: 1e-6 },
    "foreshore.herbBiomass": { abs: 1e-6 },
    "foreshore.intertidal": { abs: 0 },
    "foreshore.elev": { abs: 1e-6 },
    "terrace.marshBiomass": { abs: 1e-6 },
    "terrace.herbBiomass": { abs: 1e-6 },
    "terrace.intertidal": { abs: 0 },
    "terrace.elev": { abs: 1e-6 },
    "delta.foreshoreGuildDelta": { abs: 1e-6 },
    "delta.terraceGuildDelta": { abs: 1e-6 },
    "delta.seedMatch": { abs: 0 },
    "delta.guildSeedMatch": { abs: 0 },
  ...
  "shrub-arrival": {
    "warmCovered.shrubBiomass": { abs: 1e-6 },
    "warmCovered.herbBiomass": { abs: 1e-6 },
    "warmCovered.airTempC": { abs: 0 },
    "coldCovered.shrubBiomass": { abs: 1e-6 },
    "coldCovered.airTempC": { abs: 0 },
    "coldCovered.tempLimited": { abs: 0 },
    "mildCovered.shrubBiomass": { abs: 1e-6 },
    "mildCovered.airTempC": { abs: 0 },
    "warmBare.shrubBiomass": { abs: 1e-6 },
    "warmBare.coverLimited": { abs: 0 },
    "delta.climateDelta": { abs: 1e-6 },
    "delta.guildSeedMatch": { abs: 0 },
    "delta.replayMatch": { abs: 0 },
    "delta.hashN": { abs: 0 },
  },
  "crust-arrival": {
    "dampBare.crustBiomass": { abs: 1e-6 },
    "dampBare.moisture": { abs: 0 },
    "dryBare.crustBiomass": { abs: 1e-6 },
    "dryBare.moistureLimited": { abs: 0 },
    "dampShaded.crustBiomass": { abs: 1e-6 },
    "dampShaded.openLimited": { abs: 0 },
    "dampSalty.crustBiomass": { abs: 1e-6 },
    "dampSalty.saltLimited": { abs: 0 },
    "delta.moistureDelta": { abs: 1e-6 },
    "delta.infilDelta": { abs: 1e-6 },
    "delta.guildSeedMatch": { abs: 0 },
    "delta.replayMatch": { abs: 0 },
    "delta.hashN": { abs: 0 },
  },
