 ...
 * Light: terrainInsolation reads terrain.elevation; porosity reads soil.material —
 * both were silently consumed inside runHabitatStep without being declared (§4.48 / T-005).
